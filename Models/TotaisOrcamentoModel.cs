...
namespace OrcamentariaBackEnd
{
    public class TotaisOrcamentoModel 
    {
        ...
        private double _totaisMateriais;
        private double _totaisCustos;
        private double _totalGeral;
        private double _areaTotal;

        public TotaisOrcamentoModel(int totaisOrcamentoId, int orcamentoId, double totaisItens, 
            double totaisMaoObra, double totaisEquipamentos, double totaisMateriais, double totaisCustos, 
            double totalGeral, double areaTotal)
        {
            ...
            TOTAIS_MATERIAL = totaisMateriais;
        ...
        public double TOTAIS_MATERIAL { get => _totaisMateriais; set => _totaisMateriais = value; }
