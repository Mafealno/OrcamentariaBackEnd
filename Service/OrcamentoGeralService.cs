...
{
    public class OrcamentoGeralService
    {
        private IOrcamentoGeralRepository OrcamentoGeralRepository;
        ...
        public OrcamentoGeralService(IOrcamentoGeralRepository orcamentoGeralRepository, MetodosGenericosService metodosGenericosService,
        ...
        {
            this.OrcamentoGeralRepository = orcamentoGeralRepository;
        ...
        public IEnumerable<OrcamentoGeralModel> Get()
        {
            try
            {
                var listOrcamento = OrcamentoGeralRepository.List();
        ...
        public IEnumerable<OrcamentoGeralModel> Get(int orcamentoId)
        {
            try
            {
                ...
                listOrcamento.Add(OrcamentoGeralRepository.Find(orcamentoId));
        ...
        public void Put(int orcamentoId, OrcamentoGeralModel orcamento)
        {
            try
            {
                ...
                OrcamentoGeralRepository.Update(orcamentoId, orcamento);
            }
            catch (Exception)
            {
        ...
        public void Delete(int orcamentoId)
        {
            try
            {
                ...
                OrcamentoGeralRepository.Delete(orcamentoId);
